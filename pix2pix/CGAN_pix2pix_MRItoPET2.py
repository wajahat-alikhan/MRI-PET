...
class Discriminator3D(nn.Module):
    def __init__(self, input_channels=2, ndf=64):
        ...
        # Main layers
        self.layer1 = self._make_layer(ndf, ndf * 2)      # 64 -> 128
        self.layer2 = self._make_layer(ndf * 2, ndf * 4)  # 128 -> 256
        self.layer3 = self._make_layer(ndf * 4, ndf * 8)  # 256 -> 512

        # Final layer - Match input channels with previous layer's output
        self.final = nn.Conv3d(ndf * 8, 1, 4, stride=1, padding=1)  # 512 -> 1
